...
关于pom.xml一直提示Could not transfer artifact（无法搬运）的问题

[关于pom.xml一直提示Could not transfer artifact（无法搬运）+无法解析maven依赖（更新）的问题，我在学习springboot的过程中遇到的一些问题（持续更新中）_冲锋的禾的博客-CSDN博客](https://blog.csdn.net/m0_53623945/article/details/122660254)
...
UserMapper、Service、Impl  conrtoller
...
过滤器里面加上判断移动端是否未登陆拦截的逻辑代码



访问http://localhost:8888/front/page/login.html



浏览器以手机模式查看

![image-20220815013938788](C:\Users\LAHam\AppData\Roaming\Typora\typora-user-images\image-20220815013938788.png)
...
![image-20220815015500468](C:\Users\LAHam\AppData\Roaming\Typora\typora-user-images\image-20220815015500468.png)

![image-20220815015448514](C:\Users\LAHam\AppData\Roaming\Typora\typora-user-images\image-20220815015448514.png)

![image-20220815015510231](C:\Users\LAHam\AppData\Roaming\Typora\typora-user-images\image-20220815015510231.png)
...
- 判断手机号
- 调用阿里云api发短信（可选）
- 生成验证码（log以下），保存到session key为手机号



登陆

![image-20220815021720598](C:\Users\LAHam\AppData\Roaming\Typora\typora-user-images\image-20220815021720598.png)

![image-20220815021730213](C:\Users\LAHam\AppData\Roaming\Typora\typora-user-images\image-20220815021730213.png)

![image-20220815021800762](C:\Users\LAHam\AppData\Roaming\Typora\typora-user-images\image-20220815021800762.png)
...
原因是后台系统也有个判断是否登陆，且在移动端判断的前面，后台那里直接return了，所以要用if-elseif-else来处理，把return放在else里面

问题？----一个登陆了，另一个系统也认为登陆了
...
![image-20220816094420178](C:\Users\LAHam\AppData\Roaming\Typora\typora-user-images\image-20220816094420178.png)

套餐类型的![image-20220816094448777](C:\Users\LAHam\AppData\Roaming\Typora\typora-user-images\image-20220816094448777.png)

菜品类型

![image-20220816094502853](C:\Users\LAHam\AppData\Roaming\Typora\typora-user-images\image-20220816094502853.png)

![image-20220816094522811](C:\Users\LAHam\AppData\Roaming\Typora\typora-user-images\image-20220816094522811.png)

![image-20220816102046076](C:\Users\LAHam\AppData\Roaming\Typora\typora-user-images\image-20220816102046076.png)

![image-20220816102556482](C:\Users\LAHam\AppData\Roaming\Typora\typora-user-images\image-20220816102556482.png)

没有口味选项？---因为list方法没有返回口味信息
...
![image-20220816090039729](C:\Users\LAHam\AppData\Roaming\Typora\typora-user-images\image-20220816090039729.png)
...
![image-20220816102636292](C:\Users\LAHam\AppData\Roaming\Typora\typora-user-images\image-20220816102636292.png)



判断是否添加过，如果是则number+1
...
![image-20220816111423912](C:\Users\LAHam\AppData\Roaming\Typora\typora-user-images\image-20220816111423912.png)
...
![image-20220816111454174](C:\Users\LAHam\AppData\Roaming\Typora\typora-user-images\image-20220816111454174.png)
...
![image-20220817145153764](C:\Users\LAHam\AppData\Roaming\Typora\typora-user-images\image-20220817145153764.png)

![image-20220817145147407](C:\Users\LAHam\AppData\Roaming\Typora\typora-user-images\image-20220817145147407.png)

只给了id信息

用这些id信息（用户id、地址id）去查其他的表，把orders表信息填完

---扩展submit方法

- 购物车数据
- 插入数据（一条）到orders表
- 插入数据（多条）到orderdetail表
- 删除购物车数据
...
涉及金额----BigDecimal、Transational

AtomicInteger-----原子操作的integer（保证线程安全）
